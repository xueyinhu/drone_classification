...
def get_config():
    ...
    psr.add_argument('--train_images_num', default=1262),
    psr.add_argument('--valid_images_num', default=135)

    psr.add_argument('--net_name', default='MyNet')
    psr.add_argument('--epoch_count', default=80000)
    psr.add_argument('--batch_size', default=4)
    ...
    psr.add_argument('--data_path', default='J:/ttt_data/data_final_limit_1/')
