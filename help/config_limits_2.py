...
def get_config():
    ...
    psr.add_argument('--train_images_num', default=7479),
    psr.add_argument('--valid_images_num', default=821)

    psr.add_argument('--net_name', default='MyNet')
    psr.add_argument('--epoch_count', default=80000)
    psr.add_argument('--batch_size', default=8)
    ...
    psr.add_argument('--data_path', default='J:/data_limits/data_final_limit_2/')
