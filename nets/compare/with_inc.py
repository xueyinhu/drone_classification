...
class Inc1(Model):
    def __init__(self, c, r):
        super(Inc1, self).__init__()
        self.b1 = layers.MaxPool2D((3, 3), (2, 2), 'same')
        self.b2 = Sequential([
            layers.Conv2D(c, (3, 3), (2, 2), 'same'),
            layers.BatchNormalization(),
        ])
        self.b3 = Sequential([
            layers.Conv2D(c, (3, 3), (2, 2), 'same'),
            layers.BatchNormalization(),
            layers.Conv2D(c, (3, 3), (1, 1), 'same'),
            layers.BatchNormalization(),
            layers.Conv2D((r * c) // 1, (1, 1)),
            layers.BatchNormalization(),
        ])
